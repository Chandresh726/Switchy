...
export const settingsUpdateBodySchema = z.object({
  ...
  notifications_enabled: settingBooleanInputSchema,
  notifications_match_score_threshold: settingIntegerInputSchema,
...
export const settingsResponseSchema = z.object({
  ...
  notifications_enabled_at: z.string(),
  notifications_match_score_threshold: z.string(),
